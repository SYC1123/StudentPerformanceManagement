 ...
 * 教务处修改学生成绩
 * */
public class ChangeScoreNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private IChangeScore callback;

    private Fragment mContent;

    public ChangeScoreNetWorkHelper(Fragment appCompatActivity) {
        this.mContent = appCompatActivity;
    }

    public void setCallback(IChangeScore callback) {
