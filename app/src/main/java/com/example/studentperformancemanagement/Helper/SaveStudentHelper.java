...
public class SaveStudentHelper {
    /**
     * @param user
     */
    public static void saveUser(Context context, String preferenceName, String key, Student user) throws Exception {
    ...
    public static Student getUser(Context context, String preferenceName, String key) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(preferenceName, context.MODE_PRIVATE);
