...
public class InputScoreNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private IInputScore callback;

    private AppCompatActivity mContent;

    public InputScoreNetWorkHelper(AppCompatActivity appCompatActivity) {
    ...
    public void startNetThread(final String host, final int port, final String data, IInputScore myCallback) {
