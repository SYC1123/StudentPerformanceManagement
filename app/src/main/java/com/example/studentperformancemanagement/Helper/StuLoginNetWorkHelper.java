 ...
 * 学生登录
 * */
public class StuLoginNetWorkHelper {
    private static final int HANDLER_MSG_TELL_RECV = 1;

    private IStuLogin callback;

    private AppCompatActivity mContent;

    public StuLoginNetWorkHelper(AppCompatActivity appCompatActivity) {
    ...
    public void startNetThread(final String host, final int port, final String data, IStuLogin myCallback) {
